...
## "Schema Abstraction" in a Multiple-Trace Memory Model[@hintzman_schema_nodate]
...
- The model is able to retrieve and disambiguate a prototype of a category when probed with a alias.
